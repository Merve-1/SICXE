            ...
            if (instr.get(i).equals (OPTAB[j][0])){
                if(OPTAB[j][1].equals("2")){
                  ...
                  //if we only have 1 register
                    ...
                    temp1 = "";
                    temp2 = "";
                  //checking if it's 3 digits, if not we will add "0" until it's 6 digits
                    for(int digits = 3; digits>opcode.length(); digits--){
                        temp1 = temp1 + "0";
                        temp2 = temp2 + "0";
                    }
                    //increment by 1 until it completes the 3 digits 
                    temp1 = opcode + temp1;
                    temp2 = registers + temp2;
                    String objFormat2 = temp1 + temp2;
